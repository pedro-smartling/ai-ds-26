    ...
    return (
        <div className="flex-1 pb-20 sm:pb-0">
            ...
            <Button
                ...
                variant="primary"
                size="sm"
                className="fixed bottom-0 left-0 right-0 z-10 flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white bg-violet-600 shadow-lg sm:hidden hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500"
            >
